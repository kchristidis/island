...
import (
	...
	"github.com/kchristidis/island/exp1/agent"
	"github.com/kchristidis/island/exp1/blockchain"
	"github.com/kchristidis/island/exp1/blocknotifier"
	"github.com/kchristidis/island/exp1/crypto"
	"github.com/kchristidis/island/exp1/markend"
	"github.com/kchristidis/island/exp1/slotnotifier"
...
func run() error {
	...
	sdkctx = &blockchain.SDKContext{
		...
		ChannelConfigPath:   os.Getenv("GOPATH") + "/src/github.com/kchristidis/island/exp1/fixtures/artifacts/clark-channel.tx",
		ChaincodeGoPath:     os.Getenv("GOPATH"),
		ChaincodeSourcePath: "github.com/kchristidis/island/exp1/chaincode/",
	}
